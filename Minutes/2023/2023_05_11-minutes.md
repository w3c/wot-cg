...
Christof Küstner: We are working in the department of Data and digital solutions.

Christof Küstner: Schaeffler produces metal parts and mechatronics components. Most known product is bearings (small and large scale). Everything that is rotating have a Schaeffler product in it.

Christof Küstner: we are distributed world wide with more than 83.000 employees. Revenue 15 billions, we registered 1.250 patents. We are trying to be innovative and invest in R&D.
...
Ege: nice presentation. Thank you for sharing the challenges.
